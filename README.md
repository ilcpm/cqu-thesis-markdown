...
```text
pandoc example.md  --filter equations_no.py --filter section_break.py --filter header_convert.py --filter figures_no.py --filter refs.py --filter texcommands.py -o example.docx --reference-doc template/reference.docx
```
